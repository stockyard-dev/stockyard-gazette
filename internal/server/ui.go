...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Gazette</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Gazette</h1>
    <p>Blogging platform — write in Markdown, publish instantly, RSS out of the box</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">10 posts</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited posts</div>
